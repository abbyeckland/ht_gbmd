...
Qw_ref_path_loc = os.path.join(dirname,'../../reference/NORESM-M/Hydrotrend/HYDROASCII.Q')
Qs_ref_path_loc = os.path.join(dirname, '../../reference/NORESM-M/Hydrotrend/HYDROASCII.QS')
Qb_ref_path_loc = os.path.join(dirname, '../../reference/NORESM-M/Hydrotrend/HYDROASCII.QB')
Cs_ref_path_loc = os.path.join(dirname, '../../reference/NORESM-M/Hydrotrend/HYDROASCII.CS')
VWD_ref_path_loc = os.path.join(dirname, '../../reference/NORESM-M/Hydrotrend/HYDROASCII.VWD')
TP_ref_path_loc = os.path.join(dirname, '../../reference/NORESM-M/Hydrotrend/HYDROASCII.TEMP_PREC')
...
Qw_Qs_Qb_Cs_VWD_TP_merge_all.to_csv(dirname + '/ASCII_data_fullrecord_noresm.csv')
