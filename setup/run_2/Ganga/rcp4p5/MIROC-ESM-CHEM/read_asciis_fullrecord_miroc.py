...
Qw_ref_path_loc = os.path.join(dirname,'../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.Q')
Qs_ref_path_loc = os.path.join(dirname, '../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.QS')
Qb_ref_path_loc = os.path.join(dirname, '../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.QB')
Cs_ref_path_loc = os.path.join(dirname, '../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.CS')
VWD_ref_path_loc = os.path.join(dirname, '../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.VWD')
TP_ref_path_loc = os.path.join(dirname, '../../reference/MIROC-ESM-CHEM/Hydrotrend/HYDROASCII.TEMP_PREC')
...
Qw_Qs_Qb_Cs_VWD_TP_merge_all = Qw_Qs_Qb_Cs_VWD_TP_merge_full.append(Qw_Qs_Qb_Cs_VWD_TP_merge, ignore_index=False)
Qw_Qs_Qb_Cs_VWD_TP_merge_all = Qw_Qs_Qb_Cs_VWD_TP_merge_all.reset_index(drop=True)
Qw_Qs_Qb_Cs_VWD_TP_merge_all.to_csv(dirname + '/ASCII_data_fullrecord_miroc.csv')
