...
Hard_csv = pd.read_csv('/Users/aeckland/hydrotrend_gbmd/water_data/Ganges/Hardinge_Qw_1976-2006.csv')
...
# compare observed and simulated max sediment discharge statistics
...
collections.__file__
dirname = os.path.dirname(__file__)
filename = os.path.join(dirname, 'REF_summ_stats_v3.csv')
# writing to csv file
with open(filename, 'w') as csvfile:
    # creating a csv writer object
    csvwriter = csv.writer(csvfile)
