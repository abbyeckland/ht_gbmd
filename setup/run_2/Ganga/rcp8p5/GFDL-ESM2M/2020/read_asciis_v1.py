...
Qw_2020_path = '2020/Hydrotrend/HYDROASCII.Q'
Qw_2040_path = '2040/Hydrotrend/HYDROASCII.Q'
Qw_2060_path = '2060/Hydrotrend/HYDROASCII.Q'
Qw_2080_path = '2080/Hydrotrend/HYDROASCII.Q'

#read csvs
Qw_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.Q')
Qw_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.Q')
Qw_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.Q')
Qw_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.Q')
...
Qw_all = pd.concat([Qw_2020[1:], Qw_2040[1:], Qw_2060[1:], Qw_2080[1:]])
...
#assign text file path for a specific climate model and output variable
Qs_2020_path = '2020/Hydrotrend/HYDROASCII.QS'
Qs_2040_path = '2040/Hydrotrend/HYDROASCII.QS'
Qs_2060_path = '2060/Hydrotrend/HYDROASCII.QS'
Qs_2080_path = '2080/Hydrotrend/HYDROASCII.QS'

#read csvs
Qs_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.QS')
Qs_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.QS')
Qs_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.QS')
Qs_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.QS')
...
#print as one single record and create new dataframe
Qs_all = pd.concat([Qs_2020[1:], Qs_2040[1:], Qs_2060[1:], Qs_2080[1:]])
...
#next dataset: Qb
Qb_2020_path = '2020/Hydrotrend/HYDROASCII.QB'
Qb_2040_path = '2040/Hydrotrend/HYDROASCII.QB'
Qb_2060_path = '2060/Hydrotrend/HYDROASCII.QB'
Qb_2080_path = '2080/Hydrotrend/HYDROASCII.QB'

#read csvs
Qb_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.QB')
Qb_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.QB')
Qb_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.QB')
Qb_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.QB')
...
#print as one single record and create new dataframe
Qb_all = pd.concat([Qb_2020[1:], Qb_2040[1:], Qb_2060[1:], Qb_2080[1:]])
...
#next dataset: Cs
Cs_2020_path = '2020/Hydrotrend/HYDROASCII.CS'
Cs_2040_path = '2040/Hydrotrend/HYDROASCII.CS'
Cs_2060_path = '2060/Hydrotrend/HYDROASCII.CS'
Cs_2080_path = '2080/Hydrotrend/HYDROASCII.CS'

#read csvs
Cs_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.CS')
Cs_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.CS')
Cs_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.CS')
Cs_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.CS')
...
#print as one single record and create new dataframe
Cs_all = pd.concat([Cs_2020_split[1:], Cs_2040_split[1:], Cs_2060_split[1:], Cs_2080_split[1:]])
...
#next dataset: VWD
VWD_2020_path = '2020/Hydrotrend/HYDROASCII.VWD'
VWD_2040_path = '2040/Hydrotrend/HYDROASCII.VWD'
VWD_2060_path = '2060/Hydrotrend/HYDROASCII.VWD'
VWD_2080_path = '2080/Hydrotrend/HYDROASCII.VWD'

#read csvs
VWD_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.VWD')
VWD_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.VWD')
VWD_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.VWD')
VWD_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.VWD')
...
#print as one single record and create new dataframe
VWD_all = pd.concat([VWD_2020_split[1:], VWD_2040_split[1:], VWD_2060_split[1:], VWD_2080_split[1:]])
...
TP_2020_path = '2020/Hydrotrend/HYDROASCII.TEMP_PREC'
TP_2040_path = '2040/Hydrotrend/HYDROASCII.TEMP_PREC'
TP_2060_path = '2060/Hydrotrend/HYDROASCII.TEMP_PREC'
TP_2080_path = '2080/Hydrotrend/HYDROASCII.TEMP_PREC'

#read csvs
TP_2020_df = pd.read_csv('2020/Hydrotrend/HYDROASCII.TEMP_PREC')
TP_2040_df = pd.read_csv('2040/Hydrotrend/HYDROASCII.TEMP_PREC')
TP_2060_df = pd.read_csv('2060/Hydrotrend/HYDROASCII.TEMP_PREC')
TP_2080_df = pd.read_csv('2080/Hydrotrend/HYDROASCII.TEMP_PREC')
...
#print as one single record and create new dataframe
TP_all = pd.concat([TP_2020_split[1:], TP_2040_split[1:], TP_2060_split[1:], TP_2080_split[1:]])
...
Qw_all_np = np.array(Qw_all_df)
Qw_all_reshape = Qw_all_np.reshape(174,365)
Qw_mean_rows_obs = np.mean(Qw_all_reshape, axis = 1)

#save to csv
Qw_Qs_Qb_Cs_VWD_TP_merge.to_csv('ASCII_data.csv')
