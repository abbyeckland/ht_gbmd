...
Qw_ref_path_loc = os.path.join(dirname,'../../reference/HadGEM2/Hydrotrend/HYDROASCII.Q')
Qs_ref_path_loc = os.path.join(dirname, '../../reference/HadGEM2/Hydrotrend/HYDROASCII.QS')
Qb_ref_path_loc = os.path.join(dirname, '../../reference/HadGEM2/Hydrotrend/HYDROASCII.QB')
Cs_ref_path_loc = os.path.join(dirname, '../../reference/HadGEM2/Hydrotrend/HYDROASCII.CS')
VWD_ref_path_loc = os.path.join(dirname, '../../reference/HadGEM2/Hydrotrend/HYDROASCII.VWD')
TP_ref_path_loc = os.path.join(dirname, '../../reference/HadGEM2/Hydrotrend/HYDROASCII.TEMP_PREC')
...
Qw_Qs_Qb_Cs_VWD_TP_merge_all.to_csv(dirname + '/ASCII_data_fullrecord_hadgem.csv')
